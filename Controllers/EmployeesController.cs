    ...
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Employees != null ?
                        ...
                        Problem("Entity set 'ApplicationContext.Employees'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEmployee,EmployeeName,Salary,CompanyId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEmployee,EmployeeName,Salary,CompanyId")] Employee employee)
        {
